...
export const cvData: CVSection[] = [
  {
    ...
    content: `Detail-oriented AI data annotator and evaluator with 2+ years of experience annotating text, images, code, and audio/video. Proficient in prompt evaluation, RLHF workflows, and quality assessment for large language models. Background in graphics design, Web3 market research, product/UX design, video content creation, and business analysis provides strong contextual judgment for evaluating AI outputs across all domains.`,
    category: "summary",
  },
  {
    id: "exp-ai-annotator",
    title: "AI Data Annotator & Evaluator",
    content: `2023 - Present | Remote | Freelance. Evaluate and annotate AI-generated outputs across text, image, code, and audio/video modalities. Conduct prompt evaluation and response quality assessment for LLMs as part of RLHF workflows. Perform image and visual task annotation including object detection, segmentation, and scene description. Apply structured evaluation rubrics to rate model outputs at scale.`,
    category: "experience",
  },
  {
    id: "exp-graphics",
    title: "Graphics Designer",
    content: `2020 - Present | Remote | Freelance. Designed brand identity systems and visual assets using Canva, including logo concepts, color palettes, and design guidelines. Created marketing collateral: thumbnails, banners, social media graphics, and promotional materials for YouTube channels. Designed UI mockups and interface assets in Figma.`,
    category: "experience",
  },
  {
    id: "exp-analyst",
    title: "Market Analyst - TradeStellar",
    content: `2019 - 2026 | Remote. Analyze crypto, forex, and NFT markets to support trading strategy and decision-making. Track price action, macro trends, and on-chain signals for market intelligence reports. Develop and refine multi-market trading strategies. 6+ years in Web3/crypto market research.`,
    category: "experience",
  },
  {
    id: "exp-bd",
    title: "Business Development Specialist - IRYS Network",
    content: `2025 | Remote | Voluntary. Researched and evaluated Web3 projects for potential datachain integration opportunities. Produced detailed ecosystem research reports and published content highlighting blockchain infrastructure synergies. Engaged directly with project teams to identify improvement opportunities.`,
    category: "experience",
  },
  {
    id: "exp-ux",
    title: "UI/UX Designer - FlexiSAF Edusoft Ltd",
    content: `2023 | Abuja. Participated in structured product design sprints using Figma, contributing to components and design systems. Conducted user interviews and used results to identify friction points and improve onboarding flows. Collaborated with frontend engineers to ensure interface decisions aligned with product goals.`,
    category: "experience",
  },
  {
    id: "exp-ea",
  ...
  {
    id: "project-carlink",
    title: "CarLink - Car Marketplace App (UI/UX Case Study)",
    content: `CarLink is a swipe-based car marketplace mobile app designed for Nigeria, covering both purchase and rental discovery. Full UX process: product brief, market research, competitive analysis of Jiji, Cars45, Autochek, AutoSwiper, user personas, problem statements, information architecture, wireframes, design system, and high-fidelity UI. Key features: swipe-based discovery, dual Purchase/Rent modes, VIN checker with free spec verification and paid full history report, verified seller badges, in-app chat with WhatsApp fallback, Garage for saved cars with price-drop alerts, seller listing flow, and CarLink Pro subscription at N2500/month. Built in Figma with a full prototype available.`,
    category: "design",
  },
  {
    id: "project-singcity",
  ...
  },
  {
    ...
    content: `Live React/TypeScript application with Irys Network blockchain integration for prompt management. Demonstrates full-stack capabilities combining AI, blockchain, and modern frontend architecture. Deployed at promptvault-ai.vercel.app.`,
    category: "projects",
  },
  {
  ...
  },
  {
    ...
    content: `Chidozirim runs three YouTube channels: @mindovercomfort5 (AI-assisted video editing, lifestyle and content creation), @raregem-05 (creative video content, AI video editing techniques, original storytelling), and @tokenlogic500 (crypto and Web3 education for African audiences). Skills: AI video editing, CapCut, script writing, storyboarding, faceless content, thumbnail design, content strategy, YouTube SEO.`,
    category: "projects",
  },
  {
    id: "skills-ai",
    title: "AI & Data Annotation Skills",
    content: `Prompt Evaluation, RLHF, Text & Response Annotation, Image & Visual Annotation, CVAT, Audio/Video Annotation, Data Quality Assessment, LLM Evaluation.`,
    category: "skills",
  },
  {
    id: "skills-design",
    title: "Graphics Design & Visual Branding",
    content: `Brand Identity, Design Systems, Canva, Figma, Social Media Graphics, Thumbnail Design, Banner Design, Logo Design, Color Theory & Typography.`,
    category: "skills",
  },
  {
    id: "skills-ux",
  ...
  },
  {
    ...
    content: `HTML, CSS, JavaScript, React, TypeScript, web3.js, Next.js, Git.`,
    category: "skills",
  },
  {
    id: "education",
  ...
  },
  {
    ...
    content: `Product Design (UI/UX) - DigitallyU Academy, 2023. Web Development - DigitallyU Academy, 2023. Project Management - Exford Global, 2019. Customer Service & Relationship Management - Exford Global, 2019. Health, Safety & Environment - Exford Global, 2019.`,
    category: "certifications",
  },
  {
    id: "contact",
    title: "Contact & Social",
    content: `Email: chidozirim.ca@gmail.com. Location: Abuja, Nigeria. GitHub: github.com/Alvinfx. LinkedIn: linkedin.com/in/chidozirim-ahuakagha. X/Twitter: @XpnxvVicinity. Telegram: t.me/xvVicinity.`,
    category: "summary",
  },
];
